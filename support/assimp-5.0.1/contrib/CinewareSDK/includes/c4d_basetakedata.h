...
public:
	...
	static NodeData* Alloc() { return NewObj(TakeFolderData); }
};
...
public:
	...
	static NodeData* Alloc() { return NewObj(OverrideGroupData); }
};
...
public:
	...
	static NodeData* Alloc() { return NewObj(BaseTakeData); }
