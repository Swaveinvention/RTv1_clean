...
public:
	...
	/// @param[in] probe							The start of a small chunk of data from the start of the file for testing the file type. Usually the probe size is @em 1024 bytes. @cinewareOwnsPointed{array}
