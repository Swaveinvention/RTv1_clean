...
enum
{
	...
	RANGE_VALUESTRING,									///< @link cineware::String String@endlink The string value to be used inside the GUI to decode the current value (e.g. "lod Value" for lod object).
